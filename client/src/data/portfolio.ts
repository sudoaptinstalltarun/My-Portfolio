...
export const skills = [
  {
    ...
    items: ["ROS2 Humble", "Nav2", "SLAM", "Path Planning", "Autonomous Navigation", "Autonomous Robots", "Mobile Robotics", "Sensor Fusion", "Robot Kinematics"]
  },
  {
    id: 2,
    category: "UAV & Aerospace",
    items: ["PX4 Autopilot", "ArduPilot", "MAVROS", "Pixhawk", "GPS Navigation", "UAV Design", "Flight Controllers", "Mission Planner"]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    items: ["YOLOv8", "YOLOv5", "OpenCV", "Scikit-Learn", "Machine Learning", "Data Science", "TensorFlow"]
  },
  {
    id: 5,
    category: "Embedded Systems",
    items: ["Jetson Nano", "Raspberry Pi", "Arduino Uno / Nano", "ESP32"]
  },
  {
    id: 6,
    category: "Engineering Tools & Simulators",
    items: ["Gazebo", "MATLAB", "Simulink", "ANSYS Workbench", "NI LabVIEW"]
  },
  {
    id: 7,
    category: "CAD",
